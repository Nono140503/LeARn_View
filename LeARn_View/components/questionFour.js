const questions = [
    ...
    },
    {
      ...
      options: [
        "A) LAN covers a small geographic area, while WAN covers a large area",
    ...
    },
    {
      ...
      options: [
        ...
        "B) Virtualizing server resources in a data center",
    ...
    },
    {
      ...
      options: [
        ...
        "B) Shared resources among all devices",
    ...
    },
    {
      ...
      options: [
        ...
        "B) To connect devices and facilitate data transmission",
        "C) To store data",
