const questions = [
    {
      question: "What is the primary function of a motherboard in a computer?",
      options: [
        "A) To store data",
        "B) To connect all components and peripherals",
    ...
    },
    {
      ...
      options: [
        ...
        "B) To configure hardware settings like boot order",
    ...
    },
    {
      ...
      options: [
        ...
        "B) To reset to factory settings for troubleshooting",
    ...
    },
    {
      ...
      options: [
        "A) Install the new CPU",
        "B) Remove all peripheral devices",
    ...
    },
    {
      ...
      options: [
        ...
        "B) The form factor and processor socket",
    ...
    },
    {
      ...
      options: [
        ...
        "B) The BIOS/UEFI settings may reset, causing date and time issues",
